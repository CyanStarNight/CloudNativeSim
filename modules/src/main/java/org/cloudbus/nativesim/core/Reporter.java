...
import org.cloudbus.nativesim.service.ServiceTreeNode;

import java.text.DecimalFormat;
import java.util.List;

import static org.cloudbus.cloudsim.Log.printLine;
import static org.cloudbus.nativesim.core.Exporter.*;
...
//        at.addRow("QPS (Requests per Second)", dft.format(qps));
    ...
    public static void printChains(String API) {
        ...
        for (ServiceTreeNode root : serviceGraph.getRoots()) {
    ...
    public static void printDependenciesFromNode(ServiceTreeNode node, String indent, String API) {
        if (node == null) return;
