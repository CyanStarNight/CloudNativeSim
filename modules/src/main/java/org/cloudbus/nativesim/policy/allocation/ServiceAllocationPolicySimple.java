...
import static org.cloudbus.nativesim.service.Instance.InstanceUidMap;
...
public class ServiceAllocationPolicySimple extends ServiceAllocationPolicy {
    ...
    public boolean allocateVmForInstance(Instance instance, NativeVm vm){
        ...
        // 如果instance还未分配
        if (!getInstanceVmTable().containsKey(instance.getUid())){ //TODO: 目前只能分配cpu≤1的实例
            // 根据pe优先遍历
