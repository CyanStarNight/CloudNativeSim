...
@Getter
@Setter
public class UtilizationModelStepwise implements UtilizationModel {
     ...
     */
    public UtilizationModelStepwise(String inputPath, double schedulingInterval)
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public UtilizationModelStepwise(String inputPath, double schedulingInterval, int dataSamples)
            throws NumberFormatException,
            IOException {
        setSchedulingInterval(schedulingInterval);
