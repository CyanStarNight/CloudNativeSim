...
@Getter @Setter
public class UtilizationModelHistory implements UtilizationModel {
     ...
     */
    public UtilizationModelHistory(String inputPath, double schedulingInterval)
     ...
     * @throws IOException Signals that an I/O exception has occurred.
     */
    public UtilizationModelHistory(String inputPath, double schedulingInterval, int dataSamples)
            throws NumberFormatException,
            IOException {
        setSchedulingInterval(schedulingInterval);
